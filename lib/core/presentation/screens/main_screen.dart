    ...
    return BlocProvider<NavigationBarCubit>(
      ...
      child: BlocBuilder<NavigationBarCubit, int>(
        builder: (context, state) => Scaffold(
          ...
          //body
          body: slideFadeSwitcher(child: NavigationBarCubit.getPages()[state]),
        ),
      ),
    );
  }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      //to be changed , for demo purposes only
                      InkWell(
                        onTap: () {
                          showAppBottomSheet(
                            context: context,
                            title: l10n.chooseCity,
                            subtitle: l10n.chooseDelivery,
                            children: [
                              iconTitleButton(
                                icon: Icon(
                                ...
                                title: l10n.pickupFromJariStore,
                                context: context,
                              ),
                              SizedBox(width: 20),
                              iconTitleButton(
                                ...
                                title: l10n.deliveryToMyLocation,
                                context: context,
                              ),
                            ],
                          );
