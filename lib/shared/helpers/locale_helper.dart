...
class LocaleHelper {
  ...
  static List<Locale> getSupportedLocales(){
    return List.generate(SupportedLocaleCodes.values.length, (index)=>Locale(SupportedLocaleCodes.values[index].name));
  }

  static Locale getCurrentLocale(){

    String lang = SharedPreferencesHelper.instance.getString(langKey)??_defaultLocale.languageCode;
    return Locale(lang);
  }
  static Future<bool> saveCurrentLocale (Locale arg){
   return SharedPreferencesHelper.instance.setString(langKey, arg.languageCode);
  }
